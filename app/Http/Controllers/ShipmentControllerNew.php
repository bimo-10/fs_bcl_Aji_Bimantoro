...
class ShipmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('shipments.index')->with('success', 'Shipment created successfully! Tracking number: ' . $shipment->tracking_number);
    }
    ...
    public function update(Request $request, Shipment $shipment)
    {
        ...
        if ($validated['status'] === 'delivered' && $shipment->status !== 'delivered') {
